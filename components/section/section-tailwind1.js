...
${sectionViewSeparator('section1', showSectionSeparator)}
    ...
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <p class="max-w-2xl mb-6 font-light text-zinc-500 lg:mb-8 md:text-lg lg:text-xl dark:text-zinc-400">[TEXTO EXCELENTE QUE VAI CHAMAR ATENÇÃO DOS CLIENTES]</p>
